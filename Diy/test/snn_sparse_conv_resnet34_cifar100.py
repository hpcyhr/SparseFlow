# SNN稀疏卷积算子库 Demo — CIFAR-100版
# 针对 Spiking-ResNet34 + CIFAR-100 测试集
#
# 运行：
...
def main():
    ...
    # ---- 数据集 ----
    # CIFAR-100: 100类，测试集10000张，原始32x32，resize到224x224
    print(f"[2/4] 加载 CIFAR-100 测试集 (root={args.data_root}) ...")
    ...
    # ---- 输出报告 ----
    print("\n" + "=" * 80)
    print(f"{'SNN Sparse Conv — Spiking-ResNet34 on CIFAR-100':^70}")
...
if __name__ == "__main__":
    main()
    #python snn_sparse_conv_resnet34_cifar100.py --T 32 --batch_size 32
    #python snn_sparse_conv_resnet34_cifar100.py --T 16 --batch_size 32