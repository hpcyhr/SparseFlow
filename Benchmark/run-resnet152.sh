...
--v_threshold 1.0 \
--out_json resnet152-t8-b32-1.0.json > run1.0.log 2>&1 &
...
--data_root /home/yhr/SparseFlow/data/imagenet_val_flat \
--v_threshold 0.75 \
--out_json resnet152-t8-b32-0.75.json > run0.75.log 2>&1 &
...
--data_root /home/yhr/SparseFlow/data/imagenet_val_flat \
--v_threshold 0.5 \
--out_json resnet152-t8-b32-0.5.json > run0.5.log 2>&1 &
...
--data_root /home/yhr/SparseFlow/data/imagenet_val_flat \
--v_threshold 0.25 \
--out_json resnet152-t8-b32-0.25.json > run0.25.log 2>&1 &
